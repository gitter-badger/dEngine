...
namespace dEngine
{
	...
	public sealed class LuaTuple<T1, T2, T3, T4>
	{
		...
		{
			return new Tuple<T1, T2, T3, T4>((T1)tuple._result[0], (T2)tuple._result[1], (T3)tuple._result[2], (T4)tuple._result[3]);
		}
	...
	public sealed class LuaTuple<T1, T2, T3, T4, T5>
	{
		...
		internal LuaTuple(T1 arg1 = default(T1), T2 arg2 = default(T2), T3 arg3 = default(T3), T4 arg4 = default(T4), T5 arg5 = default(T5))
		{
		...
		{
			return new Tuple<T1, T2, T3, T4, T5>((T1)tuple._result[0], (T2)tuple._result[1], (T3)tuple._result[2], (T4)tuple._result[3], (T5)tuple._result[4]);
		}
	...
	public sealed class LuaTuple<T1, T2, T3, T4, T5, T6>
	{
		...
		internal LuaTuple(T1 arg1 = default(T1), T2 arg2 = default(T2), T3 arg3 = default(T3), T4 arg4 = default(T4), T5 arg5 = default(T5), T6 arg6 = default(T6))
		{
		...
		{
			return new Tuple<T1, T2, T3, T4, T5, T6>((T1)tuple._result[0], (T2)tuple._result[1], (T3)tuple._result[2], (T4)tuple._result[3], (T5)tuple._result[4], (T6)tuple._result[5]);
		}
		
		/// <summary/>
		public static implicit operator LuaTuple<T1, T2, T3, T4, T5, T6>(Tuple<T1, T2, T3, T4, T5, T6> tuple)
		{
			return new LuaTuple<T1, T2, T3, T4, T5, T6>(tuple.Item1, tuple.Item2, tuple.Item3, tuple.Item4, tuple.Item5, tuple.Item6);
		}
	}
	/// <summary>
	/// Represents multiple return values.
	...
	public sealed class LuaTuple<T1, T2, T3, T4, T5, T6, T7>
	{
		...
		internal LuaTuple(T1 arg1 = default(T1), T2 arg2 = default(T2), T3 arg3 = default(T3), T4 arg4 = default(T4), T5 arg5 = default(T5), T6 arg6 = default(T6), T7 arg7 = default(T7))
		{
	...
	public sealed class LuaTuple<T1, T2, T3, T4, T5, T6, T7, T8>
	{
		...
		internal LuaTuple(T1 arg1 = default(T1), T2 arg2 = default(T2), T3 arg3 = default(T3), T4 arg4 = default(T4), T5 arg5 = default(T5), T6 arg6 = default(T6), T7 arg7 = default(T7), T8 arg8 = default(T8))
		{
	...
	public sealed class LuaTuple<T1, T2, T3, T4, T5, T6, T7, T8, T9>
	{
		...
		internal LuaTuple(T1 arg1 = default(T1), T2 arg2 = default(T2), T3 arg3 = default(T3), T4 arg4 = default(T4), T5 arg5 = default(T5), T6 arg6 = default(T6), T7 arg7 = default(T7), T8 arg8 = default(T8), T9 arg9 = default(T9))
		{
	...
	public sealed class LuaTuple<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10>
	{
		...
		internal LuaTuple(T1 arg1 = default(T1), T2 arg2 = default(T2), T3 arg3 = default(T3), T4 arg4 = default(T4), T5 arg5 = default(T5), T6 arg6 = default(T6), T7 arg7 = default(T7), T8 arg8 = default(T8), T9 arg9 = default(T9), T10 arg10 = default(T10))
		{
	...
	public sealed class LuaTuple<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11>
	{
		...
		internal LuaTuple(T1 arg1 = default(T1), T2 arg2 = default(T2), T3 arg3 = default(T3), T4 arg4 = default(T4), T5 arg5 = default(T5), T6 arg6 = default(T6), T7 arg7 = default(T7), T8 arg8 = default(T8), T9 arg9 = default(T9), T10 arg10 = default(T10), T11 arg11 = default(T11))
		{
	...
	public sealed class LuaTuple<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12>
	{
		...
		internal LuaTuple(T1 arg1 = default(T1), T2 arg2 = default(T2), T3 arg3 = default(T3), T4 arg4 = default(T4), T5 arg5 = default(T5), T6 arg6 = default(T6), T7 arg7 = default(T7), T8 arg8 = default(T8), T9 arg9 = default(T9), T10 arg10 = default(T10), T11 arg11 = default(T11), T12 arg12 = default(T12))
		{
